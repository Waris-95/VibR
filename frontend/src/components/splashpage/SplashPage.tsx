    ...
    <div className="text-white">
      ...
      >
        <div className="flex flex-col items-center justify-center min-h-screen space-y-6 bg-black bg-opacity-60">
          ...
          <div className="space-x-4 animate-fadeIn delay-2s">
      ...
      <section ref={developerSectionRef} className="py-20 bg-black bg-opacity-90">
      ...
      <section ref={featuresSectionRef} className="py-20 bg-black">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl font-bold md:text-5xl">Features</h2>
          <p className="mt-4 text-lg md:text-xl">Enjoy seamless messaging, voice calls, and more with VibR's user-friendly interface and powerful features.</p>
        </div>
      </section>
    </div>
  );
